...
<?php
  $solutions = [
    'ika-visite' => [
      ...
      'image' => '<?php echo ika_asset(images/ikavisite.jpg);',
    ...
    'ika-courrier' => [
      ...
      'image' => '<?php echo ika_asset(images/ikacourrier.jpg);',
    ...
    'ika-archive' => [
      ...
      'image' => '<?php echo ika_asset(images/ikaarchive.jpg);',
    ...
    'ika-portail' => [
      ...
      'image' => '<?php echo ika_asset(images/ikaportail.jpg);',
