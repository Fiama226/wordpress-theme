      ...
      <div class="mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/yaya.jpg" alt="Yaya OUATTARA">
          </div>
        ...
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/Serge.jpg" alt="Serge Gedeon OUE">
          </div>
...
<!-- 
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/team/kader.jpg" alt="Goombasda Donald Aymard TIENTEGA">
          </div>
...
-->
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/roukiatou.jpg" alt="Roukiatou OUEDRAOGO">
          </div>
        ...
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/victorine.jpg" alt="Victorine BAZEMO">
          </div>
        ...
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/Martin.jpg" alt="Tegawende Martin Junior YAMEOGO">
          </div>
        ...
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/daouda.jpg" alt="Daouda DAO">
          </div>
        ...
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/landry.jpg" alt="KABORE Pawendtaore Landry">
          </div>
        ...
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/Sandrine.jpg" alt="Sandrine Tiahoun KINI">
          </div>
...
<!-- 
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/Fatoumata.jpg" alt="Fatoumata KANO">
          </div>
...
-->
        ...
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/ami.jpg" alt="Aminata HEMA">
          </div>
...
<!-- 
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/Koro.jpg" alt="Korotimi SANOGO">
          </div>
...
-->
        <article class="reveal group rounded-2xl bg-white p-8 text-center shadow-clean transition hover:-translate-y-2 hover:shadow-premium">
          <div class="mx-auto h-52 w-52 overflow-hidden rounded-2xl border-4 border-ikaSoft bg-ikaSoft shadow-clean">
            <img class="h-full w-full object-cover" src="assets/images/Nouriatou.jpg" alt="Nouriatou OUEDRAOGO">
          </div>
