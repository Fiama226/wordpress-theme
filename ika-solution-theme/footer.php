...
?>
  ...
  >
    ...
    <span class="grid min-w-0 gap-0.5 sm:gap-1">
      <span class="text-[10px] font-black uppercase tracking-[0.12em] text-ikaRed sm:text-xs sm:tracking-[0.16em]"><?php echo esc_html( ika_opt( 'ika_support_label' ) ); ?></span>
      <span class="whatsapp-message relative block h-5 min-w-[155px] overflow-hidden text-xs font-black text-ikaBlueDark sm:min-w-[270px] sm:text-sm">
        <span class="absolute inset-0"><?php echo esc_html( ika_opt( 'ika_support_line1' ) ); ?></span>
        <span class="absolute inset-0 opacity-0"><?php echo esc_html( ika_opt( 'ika_support_line2' ) ); ?></span>
        <span class="absolute inset-0 opacity-0"><?php echo esc_html( ika_opt( 'ika_support_line3' ) ); ?></span>
      </span>
    </span>
  </a>
  <?php endif; ?>
