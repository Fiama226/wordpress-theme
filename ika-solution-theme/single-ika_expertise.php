...
<main class="bg-white pt-32">
      ...
      <div class="hidden lg:block">
        <div class="relative">
          ...
          <div class="absolute -bottom-6 right-6 rounded-2xl bg-white p-5 text-ikaInk shadow-premium">
            <p class="text-sm font-black uppercase tracking-[0.16em] text-ikaRed"><?php echo esc_html( ika_opt( 'ika_expertise_badge_title' ) ); ?></p>
            <p class="mt-2 text-2xl font-black text-ikaBlueDark"><?php echo esc_html( ika_opt( 'ika_expertise_badge_subtitle' ) ); ?></p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="bg-white py-16 sm:py-20">
    <div class="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[.85fr_1.15fr] lg:px-8">
      <div>
        <p class="text-sm font-black uppercase tracking-[0.2em] text-ikaRed"><?php echo esc_html( ika_opt( 'ika_expertise_intervention_eyebrow' ) ); ?></p>
        <h2 class="mt-4 text-3xl font-black leading-tight text-ikaBlueDark sm:text-4xl"><?php echo esc_html( ika_opt( 'ika_expertise_intervention_title' ) ); ?></h2>
      </div>
  ...
  <section class="bg-ikaSoft py-16 sm:py-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="grid gap-10 lg:grid-cols-[.8fr_1.2fr]">
        <div>
          <p class="text-sm font-black uppercase tracking-[0.2em] text-ikaRed"><?php echo esc_html( ika_opt( 'ika_expertise_cap_eyebrow' ) ); ?></p>
          <h2 class="mt-4 text-3xl font-black leading-tight text-ikaBlueDark sm:text-4xl"><?php echo esc_html( ika_opt( 'ika_expertise_cap_title' ) ); ?></h2>
          <a href="<?php echo esc_url( home_url( '/#contact' ) ); ?>" class="mt-8 inline-flex rounded-full bg-ikaRed px-7 py-4 text-sm font-extrabold text-white shadow-clean transition hover:bg-red-700"><?php echo esc_html( ika_opt( 'ika_expertise_cap_cta' ) ); ?></a>
        </div>
  ...
  <section class="bg-white py-16 sm:py-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="grid gap-10 lg:grid-cols-2 lg:items-start">
        <?php if ( $process ) : ?>
        <div>
          <p class="text-sm font-black uppercase tracking-[0.2em] text-ikaRed"><?php echo esc_html( ika_opt( 'ika_expertise_process_eyebrow' ) ); ?></p>
          <h2 class="mt-4 text-3xl font-black text-ikaBlueDark sm:text-4xl"><?php echo esc_html( ika_opt( 'ika_expertise_process_title' ) ); ?></h2>
            ...
            <?php foreach ( $process as $index => $step ) : ?>
              <div class="flex gap-4 rounded-2xl border border-slate-100 bg-white p-5 shadow-clean">
                ...
                <div>
                  ...
                  <p class="mt-2 text-sm leading-7 text-slate-600"><?php echo esc_html( ika_opt( 'ika_expertise_process_note' ) ); ?></p>
                </div>
              </div>
            <?php endforeach; ?>
          </div>
        ...
        <div class="rounded-[2rem] bg-ikaBlueDark p-7 text-white shadow-premium sm:p-10">
          <p class="text-sm font-black uppercase tracking-[0.2em] text-red-200"><?php echo esc_html( ika_opt( 'ika_expertise_deliv_eyebrow' ) ); ?></p>
          <h2 class="mt-4 text-3xl font-black"><?php echo esc_html( ika_opt( 'ika_expertise_deliv_title' ) ); ?></h2>
          <div class="mt-8 grid gap-4">
  ...
  <section class="bg-white py-16 sm:py-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p class="text-sm font-black uppercase tracking-[0.2em] text-ikaRed"><?php echo esc_html( ika_opt( 'ika_expertise_other_eyebrow' ) ); ?></p>
          <h2 class="mt-4 text-3xl font-black text-ikaBlueDark sm:text-4xl"><?php echo esc_html( ika_opt( 'ika_expertise_other_title' ) ); ?></h2>
        </div>
        <a href="<?php echo esc_url( home_url( '/#expertises' ) ); ?>" class="inline-flex rounded-full border border-slate-200 px-6 py-3 text-sm font-black text-ikaBlue transition hover:border-ikaBlue"><?php echo esc_html( ika_opt( 'ika_expertise_other_link' ) ); ?></a>
      </div>
