    ...
    <section id="societe" class="bg-white py-20 sm:py-28">
      <div class="about-showcase mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[.95fr_1.05fr] lg:items-center lg:px-8">
        <div class="about-image-card reveal relative">
          ...
          <img class="relative h-[520px] w-full rounded-[2rem] object-cover shadow-premium" src="<?php echo esc_url( ika_asset( ika_opt( 'ika_about_image' ) ) ); ?>" alt="Présentation IKA SOLUTION">
        ...
        <div class="reveal">
          ...
          <a href="<?php echo esc_url( ika_page_url( 'presentation' ) ); ?>" class="mt-8 inline-flex rounded-full bg-ikaRed px-7 py-4 text-sm font-extrabold text-white shadow-clean transition hover:bg-red-700">En savoir plus</a>
        </div>
      </div>
    </section>
